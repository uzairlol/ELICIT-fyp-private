...
class GossipModule:
    ...
    def compile_gossip(self, all_audits):
        ...
        for audit in selected_audits:
            if self.api_client:
                ...
                tom_reasoning = audit.get('reasoning', '')
    ...
    def _generate_gossip_statement(self, source_id, target_id, score, stated_intent, contribution, endowment, tom_reasoning):
        """
        Generate a gossip statement about target agent's behavioral inconsistency, informed by ToM reasoning.
        """
...
- Agent {source_id}'s reasoning for the score: "{tom_reasoning}"
